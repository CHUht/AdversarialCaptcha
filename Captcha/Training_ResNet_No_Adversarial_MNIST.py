...
from OnePixelAttack.networks.train_plot import PlotLearning


# Code taken from https://github.com/BIGBALLON/cifar-10-cnn
class ResNet:
    def __init__(self, path, epochs=4, batch_size=128, load_weights=True):
        self.name = 'resnet'
    ...
    def train(self):
        ...
        # start training
        resnet.fit(x_train, y_train, validation_data=(x_test, y_test), batch_size=self.batch_size, epochs=self.epochs, verbose=1)
...
if __name__ == "__main__":
    ...
    ResNet = ResNet("./MODELS/ResNet_MNIST.hdf5")
    ResNet.train()