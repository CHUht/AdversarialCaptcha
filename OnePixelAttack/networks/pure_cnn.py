...
class PureCnn:
    def __init__(self,path, epochs=50, batch_size=128, load_weights=True):
        self.name               = 'pure_cnn'
    ...
    def train(self):
        ...
        model.fit(x_train, y_train, validation_data=(x_test, y_test), batch_size=self.batch_size, epochs=self.epochs, verbose=1)
