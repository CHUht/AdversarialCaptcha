...
from OnePixelAttack.networks.capsulenet.capsule_layers import CapsuleLayer, PrimaryCapsule, Length,Mask
from OnePixelAttack.networks.capsulenet.capsulenet import CapsNet as CapsNetv1
from OnePixelAttack.networks.capsulenet.helper_function import load_cifar_10,load_cifar_100
...
def train(epochs=50,batch_size=64,mode=1):
    ...
    from OnePixelAttack.networks.capsulenet.helper_function import data_generator
...
def test(epoch, mode=1):
    ...
    from OnePixelAttack.networks.capsulenet.helper_function import combine_images
