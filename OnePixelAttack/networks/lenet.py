...
class LeNet:
    def __init__(self, path,epochs=200, batch_size=128, load_weights=True):
        self.name               = 'lenet'
        self.model_filename   = path
        self.model_filename     = os.getcwd().replace("\ImageCaptcha","")
        self.model_filename     = self.model_filename + "/OnePixelAttack/networks/models/lenet.h5"
        self.num_classes        = 10
